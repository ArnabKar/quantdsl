...
class DslTestCase(unittest.TestCase):
    ...
    def calc_value(self, dsl_source, observation_date):
        ...
        evaluation_kwds = DslNamespace({
            ...
            #     'sim1#12011-01-01': Mock(spec=SimulatedPrice, value=np.array([10])),
            #     'sim1#12011-01-03': Mock(spec=SimulatedPrice, value=np.array([10])),
            #     'sim1#12011-06-01': Mock(spec=SimulatedPrice, value=np.array([10])),
            #     'sim1#12012-01-01': Mock(spec=SimulatedPrice, value=np.array([10])),
            #     'sim1#12012-01-02': Mock(spec=SimulatedPrice, value=np.array([10])),
            #     'sim1#12012-01-03': Mock(spec=SimulatedPrice, value=np.array([10])),
            #     'sim1#12012-06-01': Mock(spec=SimulatedPrice, value=np.array([10])),
            #     'sim1#12013-01-01': Mock(spec=SimulatedPrice, value=np.array([10])),
            #
            #     'sim1#22011-01-01': Mock(spec=SimulatedPrice, value=np.array([10])),
            #     'sim1#22012-01-01': Mock(spec=SimulatedPrice, value=np.array([10])),
            #
            #     'sim1TTF2012-01-01': Mock(spec=SimulatedPrice, value=np.array([10])),
            #     'sim1NBP2012-01-01': Mock(spec=SimulatedPrice, value=np.array([10])),
            #     'sim1TTF2013-01-01': Mock(spec=SimulatedPrice, value=np.array([10])),
            #     'sim1NBP2013-01-01': Mock(spec=SimulatedPrice, value=np.array([10])),
            # },
            'simulation_id': 'sim1',
        })
